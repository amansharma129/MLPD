...
const RifleQualification = () => {
            ...
            filtered[rank] = officers
                .map(officer => {
                    const filteredRecords = officer.records.filter(record => {
                        const recordDate = dayjs(record.date, 'MMMM D YYYY');
    ...
    return (
        <div className="min-h-screen p-2 sm:p-8 flex flex-col gap-8">
            <Header />
            <div>
                <h2 className="text-2xl font-bold">Rifle Qualification Report</h2>
            </div>
            {/* Date Range Modal */}
            {showDateModal && (
                                ...
                                <div key={rank} className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg mb-8">
                                    ...
                                    <div className="bg-white rounded-b-lg p-4">
                                        {officers.map(officer => (
                                            <div key={officer.officerId} className="mb-6">
...
export default RifleQualification;
